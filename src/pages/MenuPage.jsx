        ...
        <div className="grid md:grid-cols-[1fr,280px] gap-12">
          ...
          <aside className="space-y-6 md:sticky md:top-8 self-start">
            <div className="border border-line bg-paper-2 p-6">
              ...
              <p className="mt-3 text-sm text-grey-1 leading-relaxed">Alcohol works faster and harder at this altitude. Water is free, always — just ask.</p>
            </div>
            <div className="border border-line bg-paper-2 p-6">
              <Kicker>Bottles</Kicker>
              <p className="mt-3 text-sm text-grey-1 leading-relaxed">Bottle service is never suggested — only served when you ask. Its price is on this page and the zone minimum is on the zone page. Ask for a bill preview any time.</p>
            </div>
            <div className="border border-ink bg-ink text-paper p-6">
              <p className="font-display text-2xl">A table, on your terms.</p>
