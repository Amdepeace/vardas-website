...
| `enquire` | Private hire, artist and careers/supplier forms → `hire_enquiries`, `artists` (+`artist_bookings`), `applications`. | `SUPABASE_SERVICE_ROLE_KEY` |
...
supabase functions deploy enquire
